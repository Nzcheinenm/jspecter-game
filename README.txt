...
This is the readme for jspecter-game, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Jspectergame) > Ok.
...
- To run the project find Jspectergame.java (which will be in under src/main/java/nzch) and right click > Run 'Jspectergame'
